...
function HomePropertiesSection() {
  return (
    <div className='bg-primaryWhiteAccent w-full h-fit'>
      <div className="grid grid-cols-2 gap-4 py-32 w-[1240px] max-w-[88%] mx-auto">
        ...
        <div className='grid grid-cols-2 gap-4'>
           ...
           <Image src='/assets/listing-1.png' height={205*1} width={232*1}/>
           <Image src='/assets/listing-2.png' height={260*1} width={194*1}/>
            </div>
            <div className='flex flex-col gap-4 items-start -mt-28'>
            <Image src='/assets/listing-3.png' height={331*1} width={243*1}/>
           <Image src='/assets/listing-4.png' height={135*1} width={215*1}/>
            </div>
