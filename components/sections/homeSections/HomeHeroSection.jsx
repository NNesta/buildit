    ...
    <div className="headerGradient p-16 h-fit relative w-full z-10 overflow-hidden">
     ...
     <div className="grid grid-cols-7 mt-16 relative z-50 w-[1240px] max-w-[90%] mx-auto">
       ...
       <div className='flex gap-8'>
        <button className='bg-primaryGreen text-primaryWhiteAccent px-4 py-2 rounded-md font-semibold'>Services</button>
        <button className='bg-primarySky text-primaryGreenDarkish px-4 py-2 rounded-md font-semibold'>About the company</button>
       </div>
       </div>
       <div className="col-span-4 flex flex-col gap-4 items-center">
       <ul className="flex  items-end gap-4">
        
        <li><Image src='/assets/house-1.png' width={160*1} height={160*1}/></li>
        <li><Image src='/assets/house-2.png' width={250*1} height={250*1}/></li>
        <li><Image src='/assets/house-3.png' width={150*1} height={150*1}/></li>
        </ul>
        <ul className=" flex gap-8 ">
        <li><Image src='/assets/house-4.png' width={340*1} height={340*1}/></li>
        <li className='pr-12'><Image src='/assets/house-5.png' width={210*1} height={210*1}/></li>
       </ul></div>
        </div>
     </div>
